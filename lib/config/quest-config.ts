...
const QUEST_WHATSAPP_URL_BY_TEMPERATURE = {
  f: "https://sendflow.click/i/orajun26",
  org: "https://sendflow.click/i/orajun26",
  m: "https://sendflow.click/i/orajun26",
  q: "https://sendflow.click/i/orajun26",
  t: "https://sendflow.click/i/orajun26",
} as const;
