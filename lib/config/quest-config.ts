...
const QUEST_WHATSAPP_URL_BY_TEMPERATURE = {
  f: "https://sendflow.click/i/oraabr26",
  org: "https://sendflow.click/i/oraabr26",
  m: "https://sendflow.click/i/oraabr26",
  q: "https://sendflow.click/i/oraabr26",
  t: "https://sendflow.click/i/oraabr26",
} as const;
