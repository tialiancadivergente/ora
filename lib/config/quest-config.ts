...
const QUEST_WHATSAPP_URL_BY_TEMPERATURE = {
  f: "https://sendflow.click/i/oraemaio26",
  org: "https://sendflow.click/i/oraemaio26",
  m: "https://sendflow.click/i/oraemaio26",
  q: "https://sendflow.click/i/oraemaio26",
  t: "https://sendflow.click/i/oraemaio26",
} as const;
