...
export default function HeroSection({
	...
	return (
		<section
			...
			className="relative min-h-[1385px] md:min-h-0 md:h-auto flex flex-col justify-start overflow-hidden bg-[#071117] bg-[url('/images/ora/v2/hero-mobile.webp')] md:bg-[url('/images/ora/v2/hero-desktop.webp')] bg-cover md:bg-contain bg-center md:bg-top bg-no-repeat px-4 pt-5 pb-6 md:p-0"
		>
			<script
			...
			<div className="absolute top-0 left-0 z-20 hidden md:flex h-[35px] w-full items-center justify-center bg-[#917E5A] px-[490px] py-[8px]">
			...
			<div className="w-full max-w-[349px] md:w-[600px] md:max-w-none md:h-[665px] flex flex-col items-start md:items-start text-left md:text-left mt-24 md:mt-0 md:ml-[280px] mx-auto md:mx-0 md:bg-[#E9E7E4] md:px-[40px] md:pt-[64px] md:pb-[64px]">
