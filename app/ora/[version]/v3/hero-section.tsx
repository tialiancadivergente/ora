		...
		>
			<div className="w-full max-w-[349px] md:max-w-[527px] flex flex-col items-start text-left mt-[18px] md:mt-[20px] md:ml-[210px] mx-auto md:mx-0">
				...
				<div className="mt-[16px] w-full md:w-[527px] border-l-[2px] border-[#C0964B] bg-[#FFFFFF0A] backdrop-blur-[13.5px] px-[20px] md:px-[24px] py-[8px]">
					<p className="font-spectral font-semibold text-[#E0D0A6] text-[20px] md:text-[32px]">
						{subdomain === "gg" ? (
							<>
								Você já foi aliado. Já conhece o processo.
								Já esteve aqui dentro. Mas o dinheiro ainda
								não está sobrando. E você sabe que não é por
								falta de esforço.
							</>
						) : (
							<>
				...
				<p className="mt-[16px] text-white font-mulish font-normal text-[16px] leading-[145%] md:leading-[120%] tracking-[-0.02em] w-full md:w-[560px]">
					Nesse encontro{" "}
					...
					<span className="font-bold">
						novo Marca-Passos com
					</span>
					<br className="hidden md:block" />
					<span className="font-bold">
						inteligência artificial integrada
					</span>{" "}
					foi criado pra mudar isso de vez.
				</p>
				...
				<p className="mt-[12px] w-full md:w-[511px] font-mulish font-normal text-white text-[14px] md:text-[16px] leading-[120%] text-center md:text-left">
					Um encontro cara a cara com os mentores para o ex-aliado que
					quer parar de ver o dinheiro sumir e ter a certeza de um
					futuro melhor.
				</p>
			</div>
		</section>
