...
export default function ContainerQuest({
  ...
  return (
    <div>
      <section
        className={`relative flex items-center justify-center flex-col overflow-hidden h-[1333px] bg-[url('/images/ora/quiz/bg-quiz-mobile.webp')] md:bg-[url('/images/ora/v3/bg-quiz.webp')] bg-cover bg-center`}
      >
